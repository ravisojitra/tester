      ...
      >
        ...
        >
          ...
          >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Image
                        src={"images/img_telephonecall_10.svg"}
                      ...
                      >{`EN`}</Text>
                      <Image
                        src={"images/img_chevron1_15.svg"}
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >{`Program & Events`}</Text>
                          <Image
                            src={"images/img_chevron1_16.svg"}
            ...
            >
              <Text
                className="font-bold font-lora lg:leading-lh46 xl:leading-lh53 2xl:leading-lh60 3xl:leading-lh72 leading-lh8000 text-center lg:text-fs35 xl:text-fs40 2xl:text-fs45 3xl:text-fs54 text-fs60 text-white_A700 w-[100%]"
                compId="41:22"
                comWidth={1076}
                comHeight={160}
                compLeft={0}
              ...
              <Text
                className="font-cairo font-normal lg:mt-[11px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] mt-[20px] mx-[auto] not-italic text-center xl:text-fs10 2xl:text-fs12 3xl:text-fs14 text-fs16 lg:text-fs9 text-white_A700 w-[49%]"
                compId="41:23"
                comWidth={531}
                comHeight={28}
                compLeft={10}
          ...
          >
            ...
            >
              <Text
                className="font-semibold lg:mb-[21px] xl:mb-[24px] 2xl:mb-[27px] 3xl:mb-[32px] mb-[36px] lg:mt-[20px] xl:mt-[23px] 2xl:mt-[26px] 3xl:mt-[31px] mt-[35px] text-black_901 lg:text-fs15 xl:text-fs17 2xl:text-fs19 3xl:text-fs23 text-fs26 text-left w-[12%]"
                compId="41:171"
                comWidth={153}
                comHeight={38}
                compLeft={0}
              ...
              >
                <Row
                  className="bg-teal_51 items-center justify-start rounded-radius57 w-[100%]"
                  compId="1057"
                  comWidth={158}
                  comHeight={54}
                  compLeft={0}
                ...
                >
                  <Image
                    src={"images/img_linkedin11.svg"}
                    className="lg:h-[14px] xl:h-[17px] 2xl:h-[19px] 3xl:h-[22px] h-[24px] xl:ml-[11px] 2xl:ml-[12px] 3xl:ml-[15px] ml-[17px] lg:ml-[9px] xl:my-[10px] 2xl:my-[11px] 3xl:my-[13px] my-[15px] lg:my-[8px] object-contain lg:w-[14px] xl:w-[16px] 2xl:w-[18px] 3xl:w-[21px] w-[24px]"
                    compId="41:175"
                    comWidth={24}
                    comHeight={24}
                    compLeft={17}
                  ...
                  />
                  <Text
                    className="font-semibold lg:leading-lh22 xl:leading-lh25 2xl:leading-lh28 3xl:leading-lh34 leading-lh3800 ml-[10px] lg:ml-[5px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[9px] lg:my-[4px] xl:my-[5px] 2xl:my-[6px] 3xl:my-[7px] my-[8px] text-black_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[57%]"
                    compId="41:182"
                    comWidth={90}
                    comHeight={38}
                    compLeft={10}
                ...
                <div className="bg-transparent border-0 w-[100%] input-wrap">
                  <Image
                    src={"images/img_icon_11_1.svg"}
                    className="absolute left-[25.810059px] bg-transparent border-0 lg:left-[15px] xl:left-[17px] 2xl:left-[19px] 3xl:left-[23px] my-[auto] inset-y-[0]"
                    compId="41:174"
                    comWidth={10.38}
                    comHeight={19.2}
                    compLeft={0}
                  ...
                  />
                  <Input
                    className="bg-indigo_50 placeholder:bg-transparent border-0 font-semibold lg:pl-[36px] xl:pl-[41px] 2xl:pl-[46px] 3xl:pl-[55px] pl-[62.00005899999995px] lg:py-[15px] xl:py-[18px] 2xl:py-[20px] 3xl:py-[24px] py-[27.4px] rounded-radius57 placeholder:text-black_900 text-black_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[100%]"
                    compId="61"
                    comWidth={0}
                    comHeight={54}
                    compLeft={0}
                ...
                <div className="bg-transparent border-0 w-[100%] input-wrap">
                  <Image
                    src={"images/img_x30_4twitter.svg"}
                    className="absolute left-[21.400024px] bg-transparent border-0 lg:left-[12px] xl:left-[14px] 2xl:left-[16px] 3xl:left-[19px] my-[auto] inset-y-[0]"
                    compId="41:181"
                    comWidth={19.2}
                    comHeight={15.6}
                    compLeft={0}
                  ...
                  />
                  <Input
                    className="bg-light_blue_50 placeholder:bg-transparent border-0 font-semibold lg:pl-[36px] xl:pl-[41px] 2xl:pl-[46px] 3xl:pl-[55px] pl-[62.000024000000096px] lg:py-[17px] xl:py-[19px] 2xl:py-[21px] 3xl:py-[26px] py-[29.2px] rounded-radius57 placeholder:text-black_900 text-black_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[100%]"
                    compId="62"
                    comWidth={0}
                    comHeight={54}
                    compLeft={0}
          ...
          >
            ...
            >
              <Text
                className="font-bold mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] text-black_902 lg:text-fs23 xl:text-fs26 2xl:text-fs30 3xl:text-fs36 text-fs40 text-left w-[18%]"
                compId="41:254"
                comWidth={285}
                comHeight={51}
                compLeft={0}
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Text
                      className="font-lora font-medium lg:leading-lh19 xl:leading-lh22 2xl:leading-lh25 3xl:leading-lh30 leading-lh3400 lg:mt-[19px] xl:mt-[22px] 2xl:mt-[24px] 3xl:mt-[29px] mt-[33px] lg:mx-[24px] xl:mx-[27px] 2xl:mx-[30px] 3xl:mx-[37px] mx-[41.28px] text-black_900 lg:text-fs15 xl:text-fs17 2xl:text-fs19 3xl:text-fs23 text-fs26 text-left w-[76%]"
                      compId="41:261"
                      comWidth={382.8}
                      comHeight={68}
                      compLeft={41.28}
                    ...
                    <Text
                      className="font-cairo font-semibold 3xl:mt-[11px] mt-[13px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] lg:mx-[23px] xl:mx-[27px] 2xl:mx-[30px] 3xl:mx-[36px] mx-[41px] text-bluegray_700 xl:text-fs10 2xl:text-fs12 3xl:text-fs14 text-fs16 lg:text-fs9 text-left w-[58%]"
                      compId="41:263"
                      comWidth={293}
                      comHeight={28}
                      compLeft={41}
                    ...
                    <Text
                      className="font-cairo font-normal lg:leading-lh15 xl:leading-lh17 2xl:leading-lh19 3xl:leading-lh23 leading-lh2600 xl:mt-[11px] 2xl:mt-[12px] 3xl:mt-[15px] mt-[17px] lg:mt-[9px] lg:mx-[23px] xl:mx-[27px] 2xl:mx-[30px] 3xl:mx-[36px] mx-[41px] not-italic xl:text-fs10 2xl:text-fs12 3xl:text-fs14 text-fs16 lg:text-fs9 text-gray_700 text-left w-[80%]"
                      compId="41:262"
                      comWidth={407.05}
                      comHeight={52}
                      compLeft={41}
                    ...
                    <Text
                      className="font-cairo font-semibold lg:mb-[22px] xl:mb-[25px] 2xl:mb-[28px] 3xl:mb-[34px] mb-[38px] 3xl:mt-[11px] mt-[13px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] lg:mx-[24px] xl:mx-[27px] 2xl:mx-[30px] 3xl:mx-[37px] mx-[41.28px] text-bluegray_700 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[16%]"
                      compId="41:264"
                      comWidth={83}
                      comHeight={34}
                      compLeft={41.28}
          ...
          >
            ...
            >
              <Text
                className="capitalize font-bold font-lora mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] text-black_902 lg:text-fs23 xl:text-fs26 2xl:text-fs30 3xl:text-fs36 text-fs40 text-left w-[60%]"
                compId="41:197"
                comWidth={307}
                comHeight={80}
                compLeft={0}
              ...
              ></Input>
              <Button
                className="bg-bluegray_700 font-bold font-cairo ml-[1px] mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[18px] xl:mt-[20px] 2xl:mt-[23px] 3xl:mt-[27px] mt-[31px] 2xl:py-[10px] 3xl:py-[13px] py-[14.545px] lg:py-[8px] xl:py-[9px] rounded-radius37 shadow-bs2 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-white_A700 w-[51%]"
                compId="41:204"
                comWidth={261}
                comHeight={60}
                compLeft={1}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  />
                  <Text
                    className="font-normal not-italic lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_601 text-left w-[25%]"
                    compId="41:202"
                    comWidth={205}
                    comHeight={32}
                    compLeft={0}
              ...
              <Column
                className="items-end 2xl:mb-[11px] 3xl:mb-[13px] mb-[14.79px] lg:mb-[8px] xl:mb-[9px] lg:mt-[40px] xl:mt-[46px] 2xl:mt-[52px] 3xl:mt-[63px] mt-[70px] w-[100%]"
                compId="1127"
                comWidth={805}
                comHeight={21.20996}
                compLeft={0}
              ...
              >
                <Image
                  ...
                  className="lg:h-[13px] xl:h-[15px] 2xl:h-[16px] 3xl:h-[20px] h-[21.21px] mx-[10.79px] lg:mx-[6px] xl:mx-[7px] 2xl:mx-[8px] 3xl:mx-[9px] object-contain lg:w-[12px] xl:w-[14px] 2xl:w-[15px] 3xl:w-[19px] w-[21.21px]"
                  compId="44:19"
                  comWidth={21.21}
                  comHeight={21.21}
                  compLeft={10.79}
          ...
          >
            ...
            >
              <Text
                className="capitalize font-bold font-lora lg:ml-[166px] xl:ml-[190px] 2xl:ml-[214px] 3xl:ml-[257px] ml-[286px] text-black_902 lg:text-fs23 xl:text-fs26 2xl:text-fs30 3xl:text-fs36 text-fs40 text-left w-[19%]"
                compId="41:209"
                comWidth={368}
                comHeight={80}
                compLeft={286}
              ...
              <div className="2xl:mr-[214px] 2xl:my-[6px] 3xl:mr-[257px] 3xl:my-[8px] lg:mr-[166px] lg:my-[5px] mr-[286px] my-[9px] w-[8%] xl:mr-[190px] xl:my-[6px] input-wrap">
                <Image
            ...
            >
              ...
              >
                ...
                >
                  <Text
                    className="capitalize font-bold font-lora mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] text-black_901 lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-left w-[17%]"
                    compId="41:221"
                    comWidth={197}
                    comHeight={36}
                    compLeft={0}
                  ...
                  >{`James Mulyadi`}</Text>
                  <Text
                    className="font-cairo font-normal lg:leading-lh16 xl:leading-lh18 2xl:leading-lh21 3xl:leading-lh25 leading-lh2800 lg:mt-[12px] xl:mt-[14px] 2xl:mt-[15px] 3xl:mt-[18px] mt-[21px] not-italic text-black_901 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[100%]"
                    compId="41:222"
                    comWidth={1179}
                    comHeight={84}
                    compLeft={0}
                  ...
                  <Text
                    className="font-bold font-cairo mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[11px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] mt-[20px] text-bluegray_700 lg:text-fs11 xl:text-fs13 2xl:text-fs15 3xl:text-fs18 text-fs20 text-left w-[5%]"
                    compId="41:229"
                    comWidth={55}
                    comHeight={28}
                    compLeft={0}
              ...
              >
                ...
                >
                  <Text
                    className="capitalize font-bold font-lora mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] text-black_901 lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-left w-[16%]"
                    compId="41:227"
                    comWidth={187}
                    comHeight={36}
                    compLeft={0}
              ...
              >
                ...
                >
                  <Text
                    className="capitalize font-bold font-lora mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] text-black_901 lg:text-fs16 xl:text-fs18 2xl:text-fs21 3xl:text-fs25 text-fs28 text-left w-[18%]"
                    compId="41:241"
                    comWidth={186}
                    comHeight={36}
                    compLeft={0}
          ...
          >
            ...
            >
              <Image
                src={"images/img_background_22.svg"}
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Image
                    src={"images/img_telephonecall_11.svg"}
